...
public class Mat3f {
	...
	/**
	 * All matrix elements are set to 0.0f.
	 */
	public Mat3f() {
	}
	 ...
	 */
	public void zero() {
		m00 = m01 = m02 = m10 = m11 = m12 = m20 = m21 = m22 = 0f;
	}
	...
	public Vec3f times(Vec3f source) {
		return new Vec3f(
				m00 * source.x + m10 * source.y + m20 * source.z,
				m01 * source.x + m11 * source.y + m21 * source.z,
				m02 * source.x + m12 * source.y + m22 * source.z
		);
	}
	...
	/**
	 * Displays output in COLUMN-MAJOR format
	 */
	@Override
	public String toString() {
		return "X Axis: " + Utils.df.format(m00) + ",\t" + Utils.df.format(m01) + ",\t" + Utils.df.format(m02) + Utils.NEW_LINE +
				"Y Axis: " + Utils.df.format(m10) + ",\t" + Utils.df.format(m11) + ",\t" + Utils.df.format(m12) + Utils.NEW_LINE +
				"Z Axis: " + Utils.df.format(m20) + ",\t" + Utils.df.format(m21) + ",\t" + Utils.df.format(m22) + Utils.NEW_LINE;
	}
