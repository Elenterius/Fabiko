...
public interface FabrikChain<B extends FabrikBone<V, J>, V extends Vectorf<V>, J extends FabrikJoint<J>, C extends BaseboneConstraintType> {
	...
	/**
	 * Return the base bone relative unit vector of this chain.
	 * <p>
	 ...
	 *
	 * @return The base bone relative constraint UV as updated (on solve) by the structure containing this chain.
	 */
	...
	/**
	 * Return whether this chain uses an embedded target.
	 * <p>
	 * Embedded target mode may be enabled or disabled using {@link #setEmbeddedTargetMode(boolean)}.
	 *
	 * @return whether this chain uses an embedded target.
	 */
